...
$string['modulename'] = '練習課題';
$string['modulenameplural'] = '練習課題';
...
$string['playcountlabel'] = '再生回数';
$string['playtxtlabel'] = 'テキスト再生';
$string['pluginadministration'] = 'puhrec の管理';
$string['pluginname'] = 'PUH録音ツール';
$string['practicetext'] = '練習用テキスト';
...
$string['trantxt'] = '文字化テキスト';

$string['ungradedstudents'] = '録音送信後、まだ採点が行われていません';
$string['uploadmanualy'] = 'ファイルをアップロードする';
$string['usemodernbrowser'] = 'Chromeの最新版で開いてください。';
$string['puhrecfieldset'] = '録音と内容を表示する';
$string['puhrecname'] = 'この練習問題の名称';
$string['puhrecname_help'] = 'このモジュールは受講生に対して録音問題を表示することができます。';
$string['puhrecording'] = 'あなたの録音';
