...
class update_grade extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('graderecdvoice', 'puhrec');
    }
	public function get_description() {
	    return "graded a user with id {$this->userid}'s recorded voice in the category with id {$this->objectid} in the puhrec with course module id {$this->contextinstanceid}.";
    }
