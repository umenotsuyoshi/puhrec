...
class voice_save_error extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventvoicesaveerror', 'puhrec');
    }
	public function get_description() {
	    return "The user with id {$this->userid} save error [ {$this->data['other']['err_type']} ] in the category with id {$this->objectid} in the puhrec with course module id {$this->contextinstanceid}.";
    }
