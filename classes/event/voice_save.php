 ...
 */
namespace mod_puhrec\event;

defined('MOODLE_INTERNAL') || die();

/**
 * The mod_puhrec instance list viewed event class
 *
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class voice_save extends \core\event\base {
    ...
    protected function init() {
        ...
        $this->data['objecttable'] = 'puhrec';
    }
    public static function get_name() {
        return get_string('eventvoicesave', 'puhrec');
    }
	public function get_description() {
	    return "The user with id {$this->userid} save recorded voice in the category with id {$this->objectid} in the puhrec with course module id {$this->contextinstanceid}.";
    }
